...
// Each machine coding challenge lives in its own folder under src/challenges/.
// App only renders the active challenge entry component so switching challenges
